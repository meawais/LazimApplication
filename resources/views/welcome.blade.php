...
<!-- Mirrored from themeperch.net/html/eventiva/home-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 May 2024 15:17:41 GMT -->
...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,600;1,700;1,800&amp;family=Plus+Jakarta+Sans:wght@400;600&amp;family=Poppins:wght@600;800&amp;family=Roboto:wght@400;500;700;900&amp;display=swap"
        rel="stylesheet">
...
<body class="home-1">
    ...
    <div class="preloader">
        <dotlottie-player src="https://lottie.host/d851f1dc-6ef5-40be-8ca8-bbffcd018276/wutdxEizj0.json"
            background="#04000A" speed="1" style="width: 100%; height: 100%" direction="1" mode="normal" loop
            autoplay>
        </dotlottie-player>
    ...
    <!-- Header ======================-->
    <header class="header-section header-2 ordered-list-header sticky-navbar hover-menu">
        <div class="container">
            <nav class="navbar navbar-expand-xl">
                <div class="d-flex w-100 justify-content-between align-items-center">
                    <a class="navbar-brand" href="index-2.html" aria-label="nav-brands">
                        <img src="assets/images/global/logo.png" class="logo-light" alt="logo">
                        ...
                        <div class="d-flex gap-40 align-items-center">
                            <ul class="list-unstyled d-flex gap-40 navbar-nav mb-2 me-2 mb-lg-0">
                                <li class="nav-item dropdown single-pages-dropdown">
                                    <a class="nav-link dropdown-toggle active d-flex align-items-end gap-0 flex-column text-uppercase"
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="home-1.html" target="_blank"
                                                aria-label="single-pages">Home 1</a></li>
                                        <li><a class="dropdown-item" href="home-2.html" target="_blank"
                                                aria-label="single-pages">Home 2</a></li>
                                        <li><a class="dropdown-item" href="home-3.html" target="_blank"
                                                aria-label="single-pages">Home 3</a></li>
                                        <li><a class="dropdown-item" href="home-4.html" target="_blank"
                                                aria-label="single-pages">Home 4</a></li>
                                        <li><a class="dropdown-item" href="home-5.html" target="_blank"
                                                aria-label="single-pages">Home 5</a></li>
                                        <li><a class="dropdown-item" href="home-6.html" target="_blank"
                                                aria-label="single-pages">Home 6</a></li>
                                        <li><a class="dropdown-item" href="home-7.html" target="_blank"
                                                aria-label="single-pages">Home 7</a></li>

                                    </ul>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link d-flex align-items-end gap-0 flex-column text-uppercase"
                                        href="about-us.html" aria-label="nav-links">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link d-flex align-items-end gap-0 flex-column text-uppercase"
                                        href="venue.html" aria-label="nav-links">
                                        <span class="fw-bold">03</span>
                                        <span class="fw-semibold">Venue</span>
                                    </a>
                                </li>
                                <li class="nav-item dropdown single-pages-dropdown">
                                    <a class="nav-link dropdown-toggle d-flex align-items-end gap-0 flex-column text-uppercase"
    ...
    <div class="offcanvas offcanvas-top" id="navContentmenu" data-bs-backdrop="static" tabindex="-1">
        <div class="offcanvas-header">
            <a class="navbar-brand" href="index-2.html" aria-label="nav-brands"><img
                    src="assets/images/global/logo.png" alt="logo"></a>
        ...
        <div class="offcanvas-body d-flex justify-content-center">
            <ul class="navbar-nav custom-navbar-nav mb-2 mb-lg-0">
                <li class="nav-item dropdown offcanvas-pages-dropdown">
                    <a class="nav-link dropdown-toggle active text-uppercase" aria-current="page" href="#"
                ...
                <li class="nav-item">
                    <a class="nav-link text-uppercase" href="about-us.html" aria-label="nav-links">
                        <span class="fw-semibold">About Us</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-uppercase" href="venue.html" aria-label="nav-links">
                        <span class="fw-semibold">Venue</span>
                    </a>
                </li>
                <li class="nav-item dropdown offcanvas-pages-dropdown">
                    <a class="nav-link dropdown-toggle text-uppercase" href="#" aria-label="nav-links"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        <span class="fw-semibold">Blog</span>
                    </a>
                    <ul class="dropdown-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link text-uppercase" href="contact-us.html" aria-label="nav-links">
                        <span class="fw-semibold">Contact Us</span>
                    </a>
                </li>
            </ul>
    ...
    <div class="main" data-bs-spy="scroll" data-bs-target="#navContentmenu" data-bs-root-margin="0px 0px -50%"
        ...
        <!--Hero Section ======================-->
        <section class="hero-section hero-2 position-relative">
            <div class="hero-wrapper mx-auto position-relative parallax">
                <div class="container">
                    <div class="hero-inner-text position-relative">
                        ...
                        <h1 class="soundscapes fs-120 fw-extra-bold mb-0">Unveil the Magic of Soundscapes</h1>
                        <div class="circle-wrapper hero-2-circle">
                            <div class="star-icon">
                        ...
                        <div class="mb-30 mb-xxl-50 hero-brand-images">
                            <h3 class="fst-italic fw-semibold mb-20 text-white">Powered by</h3>
                            <div class="d-flex flex-md-wrap align-items-center gap-20 gap-md-5 gap-lg-50">
                                <a href="#" aria-label="brand-image">
                                    <img src="assets/images/hero-brand-1.png" class="img-fluid" alt="img">
                                </a>
                                <a href="#" aria-label="brand-image">
                                    <img src="assets/images/hero-brand-2.png" class="img-fluid" alt="img">
                                </a>
                                <a href="#" aria-label="brand-image">
                                    <img src="assets/images/hero-brand-3.png" class="img-fluid" alt="img">
                                </a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="event-info event-info-outside custom-inner-bg">
                            ...
                            <div class="col-md-3 col-xxl-2 col-xl-3 col-lg-3">
                                <div>
                                    <a href="#schedule" class="btn btn-gradient d-inline-flex align-items-center"
                                        aria-label="buttons"><span class="contact-plus-icon"><svg width="38"
                                                height="30">
        ...
        <!--Countdown Section ======================-->
        <div class="countdown-section pb-30 pb-lg-60 pb-xl-90 pt-150 pt-xxl-180 position-relative">
            <div class="container">
                <!--CountDown Section ======================-->
                            ...
                            <h2 class="title display-3 fw-extra-bold d-flex flex-column">
                                ...
                                <span class="sub-title fw-extra-bold">
                                    <svg class="gradient-subtitle">
                                        <g>
                                            <text id="text" class="gradient-subtitle-text" y="100"
                                                stroke-width="1.5" stroke="url(#gradient-subtitle)"
                                                fill="none">Extravaganza</text>
                                        </g>
                                    </svg>
                                </span>
                            </h2>
                    ...
                    <div class="col-lg-6">
                        <div class="award-left-content py-lg-100">
                            <div class="section-title section-title-style-2 mb-4 mb-lg-30 mb-xxl-40">
                                <span class="fs-3 straight-line-wrapper fw-semibold position-relative"> <span
                                        class="straight-line"></span>Special Guest Spotlight</span>
                                <h2 class="title display-3 fw-extra-bold d-flex flex-column">
                                    ...
                                    <span class="sub-title fw-extra-bold">
                                        <svg class="gradient-subtitle">
                                            <g>
                                                <text id="text" class="gradient-subtitle-text" y="100"
                                                    stroke-width="1.5" stroke="url(#gradient-subtitle)"
                                                    fill="none">Melisma</text>
                                            </g>
                                        </svg>
                                    </span>
                                </h2>
                                <p class="mb-0 mt-30">
                                    Witness Aiden Melisma's enchanting performance. Renowned for soulful melodies, his
                                    talent adds a unique dimension to Harmonia. Don't miss this captivating experience.
                                </p>
                            </div>
                            <!-- section-title -->
                            ...
                            <div class="award-wrapper d-flex flex-column gap-40 mb-40 mb-lg-60">
                                <div class="award-info d-flex gap-4">
                                    ...
                                    <div class="award-details">
                                        ...
                                        <p class="mb-0">Aiden Melisma's melodies enchanted hearts, winning him the
                                            Grammy for "Best Contemporary Album."</p>
                                    </div>
                                </div>
                                <!-- award-info -->
                                ...
                                <div class="award-info d-flex gap-4">
                                    ...
                                    <div class="award-details">
                                        ...
                                        <p class="mb-0">Aiden's hit "Ethereal Echoes" claimed the Billboard Music
                                            Award for "Top Streaming Song.""</p>
                                    </div>
                                </div>
                                <!-- award-info -->
                            ...
                            <div>
                                <a href="#"
                                    ...
                                    aria-label="buttons"><span class="gradient-btn-arrow"><svg width="30"
                                            height="30">
                    ...
                    <div class="col-lg-6">
                        <div class="award-image position-relative">
                            ...
                            <a href="http://www.youtube.com/watch?v=0O2aH4XLbto"
                                class="video-popup video-popup-left position-absolute video-popup-link">
            ...
            <div class="marquee-elements">
                <div class="scroll-elements">
                    <span class="scroll-items js-elements">
                        <span
                            class="scroll-light-text fs-180 fw-extra-bold text-uppercase d-flex gap-10 mb-0"><span>experience</span>
                            <span class="mx-10 mx-lg-4">/</span><span
                                class="primary-text-shadow me-30 me-lg-50">celebrate</span> </span>
                    </span>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="lineup-right-content mt-30 mt-lg-0">
                            ...
                            <p class="mb-4 mb-lg-30">
                                Unleash the rhythm with an extraordinary lineup. Get ready for a musical extravaganza
                                that will captivate your senses.
                            </p>

                            <div class="py-2 pb-lg-0 pt-lg-3">
                                <a href="#" class="download-link d-flex align-items-center gap-30"
                            ...
                            <div class="swiper lineup-swiper">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="lineup-image-wrapper position-relative">
                                            <div class="lineup-image">
                                                <img src="assets/images/home-1/lineup-image-1.jpg" class="img-fluid"
                                                    alt="lineup-image">
                                            </div>
                                            <div class="lineup-image-hover">
                                                ...
                                                <div class="line-up-hover-content">
                                                    <h5 class="fw-medium mb-20">Genere : <span
                                                            class="text-uppercase">pop</span></h5>
                                                    <div
                                                        class="line-up-icons d-flex align-items-center gap-3 gap-lg-20">
                                                        <a href="#" class="facebook-icon"
                                                            aria-label="facebook"><svg width="20" height="20">
                                                                <use xlink:href="#facebook-icon"></use>
                                                            </svg></a>
                                                        <a href="#" class="instagram-icon"
                                                            aria-label="instagram"><svg width="20"
                                                                height="20">
                                                                <use xlink:href="#instagram-icon"></use>
                                                            </svg></a>
                                                        <a href="#" class="youtube-icon"
                                                            aria-label="youtube"><svg width="20" height="20">
                                                                <use xlink:href="#youtube-icon"></use>
                                                            </svg></a>
                                                        <a href="#" class="spotify-icon"
                                                            aria-label="spotify"><svg width="20" height="20">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="lineup-image-wrapper position-relative">
                                            <div class="lineup-image">
                                                <img src="assets/images/home-1/lineup-image-2.jpg" class="img-fluid"
                                                    alt="lineup-image">
                                            </div>
                                            <div class="lineup-image-hover">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="lineup-image-wrapper position-relative">
                                            <div class="lineup-image">
                                                <img src="assets/images/home-1/lineup-image-3.jpg" class="img-fluid"
                                                    alt="lineup-image">
                                            </div>
                                            <div class="lineup-image-hover">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="lineup-image-wrapper position-relative">
                                            ...
                                            <div class="lineup-image-hover">
                                                ...
                                                <div class="line-up-hover-content">
                                                    <h5 class="fw-medium mb-20">Genere : <span
                                                            class="text-uppercase">hio-hop</span></h5>
                                                    <div
                                                        class="line-up-icons d-flex align-items-center gap-3 gap-lg-20">
                                                        <a href="#" class="facebook-icon"
                                                            aria-label="facebook"><svg width="20" height="20">
                ...
                <div class="row gy-4 gy-lg-0 align-items-lg-end justify-content-lg-between mb-40 mb-lg-80 mb-xxl-100">
                    ...
                    <div class="col-lg-5">
                        <div class="highlights-text">
                            <p class="text-lg-end">
                                Immerse in mesmerizing performances and interactive art at our music extravaganza.
                                Experience festival atmosphere like no other, where unforgettable moments await.
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <ul class="list-unstyled mb-0 d-flex flex-column gap-10">
                                <li>
                                    ...
                                    <div class="schedule-content">
                                        ...
                                        <p class="mb-0">
                                            Kick off the festivities as the gates open to welcome music enthusiasts from
                                            all around.
                                        </p>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="schedule-content">
                                        ...
                                        <h3 class="fw-extra-bold text-opacity">Opening Ceremony with Celestial Rhythms:
                                        </h3>
                                        <p class="mb-0">
                                            Begin the musical journey with a mesmerizing opening ceremony by the
                                            celestial music ensemble, Celestial Rhythms, setting the harmonious tone for
                                            the event.
                                        </p>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="schedule-content">
                                        ...
                                        <p class="mb-0">
                                            Get ready to dance as the electrifying duo Astral Beats takes the main
                                            stage, delivering an immersive blend of electronic and live instruments.
                                        </p>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="schedule-content">
                                        ...
                                        <h3 class="fw-extra-bold text-opacity">Lunar Lounge with Luna Serenade (VIP
                                            Area):</h3>
                                        <p class="mb-0">
                                            VIP ticket holders can unwind and indulge in the soothing melodies of Luna
                                            Serenade at the exclusive Lunar Lounge, offering a more intimate and unique
                                            experience.
                                        </p>
                                    </div>
                                </li>
                            ...
                            <ul class="list-unstyled mb-0 d-flex flex-column gap-10">
                                <li>
                                    ...
                                    <div class="schedule-content">
                                        ...
                                        <h3 class="fw-extra-bold text-opacity">Yoga & Meditation with Echo Harmony:
                                        </h3>
                                        <p class="mb-0">
                                            Kick off the festivities as the gates open to welcome music enthusiasts from
                                            all around.
                                ...
                                <li>
                                    ...
                                    <div class="schedule-content">
                                        ...
                                        <h3 class="fw-extra-bold text-opacity">Interactive Art Installations with
                                            Velvet Vibe:</h3>
                                        <p class="mb-0">
                                            Get ready to dance as the electrifying duo Astral Beats takes the main
                                            stage, delivering an immersive blend of electronic and live instruments.
                                ...
                                <li>
                                    ...
                                    <div class="schedule-content">
                                        ...
                                        <h3 class="fw-extra-bold text-opacity">Enchanting Melodies at the Harmony
                                            Stage:</h3>
                                        <p class="mb-0">
                                            VIP ticket holders can unwind and indulge in the soothing melodies of Luna
                                            Serenade at the exclusive Lunar Lounge, offering a more intimate and unique
                                ...
                                <li>
                                    ...
                                    <div class="schedule-content">
                                        <h5 class="fw-semibold">8:00 PM</h5>
                                        <h3 class="fw-extra-bold text-opacity">Festival Jam Session: Harmony Collective
                                            & Special Guests:</h3>
                                        <p class="mb-0">
                                            VIP ticket holders can unwind and indulge in the soothing melodies of Luna
                                            Serenade at the exclusive Lunar Lounge, offering a more intimate and unique
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="pricing-wrapper bg-ticket position-relative">
                            <div class="pricing-top-content">
                                ...
                                <h3 class="mb-40">
                                    <span class="display-2 fw-extra-bold primary-text-shadow me-10">$42</span><span
                                        class="fw-semibold pricing-subtitle">/ Person</span>
                                </h3>
                                <ul class="pricing-list list-unstyled d-flex flex-column gap-10">
                                    <li class="mb-0"><span class="check-icon"><svg width="16" height="16">
                                            ...
                                            </svg></span>Access to the Event</li>
                                    <li class="mb-0"><span class="check-icon"><svg width="16" height="16">
                                                <use xlink:href="#check-icon"></use>
                                            </svg></span>Affordable Entertainment</li>
                                    <li class="mb-0"><span class="check-icon"><svg width="16" height="16">
                                                <use xlink:href="#check-icon"></use>
                                            </svg></span>Shared Memories</li>
                                </ul>
                            </div>
                                ...
                                <svg viewBox="0 0 420 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <defs>
                                        ...
                                        <clipPath id="clip1_3632_1203">
                                            <rect width="420" height="616" fill="white"
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="pricing-wrapper bg-ticket position-relative">
                            <div class="pricing-top-content">
                                <div class="pricing-icon mb-10">
                                    <svg width="55" height="49">
                                        <use xlink:href="#pricing-2-icon"></use>
                                    </svg>
                                </div>
                                <h3 class="fw-semibold pricing-title">VIP Experience</h3>
                                <h3 class="mb-40">
                                    <span class="display-2 fw-extra-bold primary-text-shadow me-10">$100</span><span
                                        class="fw-semibold pricing-subtitle">/ Person</span>
                                </h3>
                                <ul class="pricing-list list-unstyled d-flex flex-column gap-10">
                                    <li class="mb-0"><span class="check-icon"><svg width="16" height="16">
                                                <use xlink:href="#check-icon"></use>
                                            </svg></span>Premium Seating</li>
                                    <li class="mb-0"><span class="check-icon"><svg width="16" height="16">
                                                <use xlink:href="#check-icon"></use>
                                            </svg></span>Backstage Access</li>
                                    <li class="mb-0"><span class="check-icon"><svg width="16" height="16">
                                                <use xlink:href="#check-icon"></use>
                                            </svg></span>Artist Interaction</li>
                                </ul>
                            </div>
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="pricing-wrapper bg-ticket position-relative">
                            <div class="pricing-top-content">
                                <div class="pricing-icon mb-10">
                                    <svg width="55" height="49">
                                        <use xlink:href="#pricing-3-icon"></use>
                                    </svg>
                                </div>
                                <h3 class="fw-semibold pricing-title">Student Discount</h3>
                                <h3 class="mb-40">
                                    <span class="display-2 fw-extra-bold primary-text-shadow me-10">$25</span><span
                                        class="fw-semibold pricing-subtitle">/ Person</span>
                                </h3>
                                <ul class="pricing-list list-unstyled d-flex flex-column gap-10">
                                    <li class="mb-0"><span class="check-icon"><svg width="16" height="16">
                                                <use xlink:href="#check-icon"></use>
                                            </svg></span>Affordable Access</li>
                                    <li class="mb-0"><span class="check-icon"><svg width="16" height="16">
                                                <use xlink:href="#check-icon"></use>
                                            </svg></span> Cultural Enrichment</li>
                                    <li class="mb-0"><span class="check-icon"><svg width="16" height="16">
                                                <use xlink:href="#check-icon"></use>
                                            </svg></span>Community Connection</li>
                                </ul>
                            </div>
        ...
        <!--Faq Section ======================-->
        <section class="faq-section faq-1 pb-50 pb-lg-100 pb-xxl-120 pt-30 pt-lg-80">
            <div class="container">
                            ...
                            <div class="accordion" id="faq-1-accordion">
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button
                                            ...
                                            <span class="text-opacity">What is the date and location of the Harmonia
                                                music concert?</span>
                                    ...
                                    <div id="itemOne" class="accordion-collapse collapse"
                                        ...
                                        <p class="accordion-body pt-0 mb-0">
                                            Outside food and beverages are not allowed inside the event grounds. We have
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button
                                            ...
                                            <span class="text-opacity">How can I purchase tickets for the
                                                event?</span>
                                            <span class="faq-arrow"><svg width="35" height="35">
                                                    <use xlink:href="#faq-arrow"></use>
                                                </svg></span>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button
                                            class="accordion-button d-flex justify-content-between align-items-center collapsed"
                                            type="button" data-bs-toggle="collapse" data-bs-target="#itemFive"
                                            aria-expanded="false" aria-controls="itemFive">
                                    ...
                                    <div id="itemFive" class="accordion-collapse collapse"
                                        data-bs-parent="#faq-1-accordion">
                                        <p class="accordion-body pt-0 mb-0">
                                            Outside food and beverages are not allowed inside the event grounds. We have
                                            a wide selection of food vendors and specialty beverages to cater to your
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button
                                            class="accordion-button d-flex justify-content-between align-items-center collapsed"
                                            type="button" data-bs-toggle="collapse" data-bs-target="#itemSix"
                                            aria-expanded="false" aria-controls="itemSix">
                                            <span class="text-opacity">Is the event accessible for individuals with
                                                disabilities?</span>
                                            <span class="faq-arrow"><svg width="35" height="35">
                                                    <use xlink:href="#faq-arrow"></use>
                                                </svg></span>
                                    ...
                                    <div id="itemSix" class="accordion-collapse collapse"
                                        data-bs-parent="#faq-1-accordion">
                                        <p class="accordion-body pt-0 mb-0">
                                            Outside food and beverages are not allowed inside the event grounds. We have
                                            a wide selection of food vendors and specialty beverages to cater to your
        ...
        <section id="sponsor"
            ...
            <div class="container">
                <div class="row gy-4 gy-lg-0 align-items-lg-end justify-content-lg-between mb-30 mb-lg-70">
                    ...
                    <div class="col-lg-5">
                        <div class="highlights-text">
                            <p class="custom-sans text-lg-end">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="brand-image position-relative">
                                    <a href="#">
                                        <img src="assets/images/home-2/brand-4.png" class="img-fluid"
                                            alt="brand-image">
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="brand-image position-relative">
                                    <a href="#">
                                        <img src="assets/images/home-2/brand-5.png" class="img-fluid"
                                            alt="brand-image">
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="brand-image position-relative">
                                    <a href="#">
                                        <img src="assets/images/home-2/brand-1.png" class="img-fluid"
                                            alt="brand-image">
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="brand-image position-relative">
                                    <a href="#">
                                        <img src="assets/images/home-2/brand-3.png" class="img-fluid"
                                            alt="brand-image">
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="brand-image position-relative">
                                    <a href="#">
                                        <img src="assets/images/home-2/brand-2.png" class="img-fluid"
                                            alt="brand-image">
                                    </a>
                                </div>
                            </div>
        ...
        <!--Gallery Section ======================-->
        <div class="gallery-section gallery-1 pt-70 pt-lg-100 pt-xxl-120 pb-70 pb-lg-100 pb-xxl-120">

            <div class="swiper swiper_gallery">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="gallery-image">
                            <a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="video-popup-link hover-area"
                    ...
                    <div class="swiper-slide">
                        <div class="gallery-image">
                            <a href="assets/images/gallery-2.jpg" class="image-link hover-area"
                    ...
                    <div class="swiper-slide">
                        <div class="gallery-image">
                            <a href="assets/images/gallery-4.jpg" class="image-link hover-area"
                                data-cursor-text="Image">
                    ...
                    <div class="swiper-slide">
                        <div class="gallery-image">
                            <a href="assets/images/gallery-5.jpg" class="image-link hover-area"
                                data-cursor-text="Image">
                                <img src="assets/images/gallery-5.jpg" alt="img">
                            </a>
                        </div>
            ...
            <div class="swiper swiper_gallery2">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="gallery-image">
                            <a href="assets/images/gallery-6.jpg" class="image-link hover-area"
                                data-cursor-text="Image">
                                <img src="assets/images/gallery-6.jpg" alt="img">
                            </a>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="gallery-image">
                            <a href="assets/images/gallery-8.jpg" class="image-link hover-area"
                                data-cursor-text="Image">
                    ...
                    <div class="swiper-slide">
                        <div class="gallery-image">
                            <a href="assets/images/gallery-10.jpg" class="image-link hover-area"
                                data-cursor-text="Image">
                    ...
                    <div class="swiper-slide">
                        <div class="gallery-image">
                            <a href="assets/images/gallery-1.jpg" class="image-link hover-area"
                                data-cursor-text="Image">
                                <img src="assets/images/gallery-1.jpg" alt="img">
                            </a>
                        </div>
                                        ...
                                        <div class="row gy-4 align-items-center justify-content-between">
                                            <div class="col-12">
                                                <div class="blog-image">
                                                    <img src="assets/images/home-2/blog-image-1.jpg"
                                                        class="img-fluid" alt="img">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="blog-left-content">
                                                    <p><span class="calendar me-10"><svg width="16"
                                                                height="17">
                                                                <use xlink:href="#calendar"></use>
                                                            </svg></span>09 Aug 2023</p>
                                                    <h2 class="blog-link fs-4 fw-bold"><a
                                                            class="text-decoration-none"
                                                            href="blog-single-1.html">Unveils Star-Studded Lineup for
                                                            Epic Comeback Event!</a></h2>
                                                    <p class="py-20 mb-3 mb-lg-0">Get ready for a musical extravaganza
                                                        like never before as Harmonia Music ...</p>
                                                    <div>
                                                        <a href="blog-single-1.html"
                                                            class="download-link d-flex align-items-center gap-30"
                                                            aria-label="buttons">Read more<span
                                                                class="ticket-arrow arrow-up-right"><svg
                                                                    width="32" height="32">
                                                                    <use xlink:href="#arrow-up-right"></use>
                                                                </svg></span></a>
                                                    </div>
                                ...
                                <div class="blog-content">
                                    <div class="blog-content-2 custom-inner-bg">
                                        <div class="row gy-4 align-items-center justify-content-between">
                                            <div class="col-12">
                                                <div class="blog-image">
                                                    <img src="assets/images/home-2/blog-image-2.jpg"
                                                        class="img-fluid" alt="img">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                ...
                                <div class="blog-content">
                                    <div class="blog-content-2 custom-inner-bg">
                                        <div class="row gy-4 align-items-center justify-content-between">
                                            <div class="col-12">
                                                <div class="blog-image">
                                                    <img src="assets/images/home-2/blog-image-3.jpg"
                                                        class="img-fluid" alt="img">
                                                </div>
                                            </div>
                                            <div class="col-12">
                ...
                <div class="row gy-20 gy-lg-0 align-items-lg-center justify-content-lg-between">
                    <div class="col-lg-4">
                        <div class="d-flex justify-content-between align-items-center">
                            <h2
                                class="fs-180-style-2 fw-extra-bold text-secondary d-flex align-items-center gap-2 mb-0">
                            ...
                            <div class="d-block d-lg-none">
                                <div class="cta-icon">
                                    <a href="#ticket" aria-label="icons">
                                        <span class="arrow-up-right-big arrow-secondary"><svg>
                    ...
                    <div class="col-lg-3">
                        <div class="cta-icon d-none d-lg-block ms-xl-70 ms-xxl-100">
                            <a href="#ticket" aria-label="icons">
                                <span class="arrow-up-right-big arrow-secondary"><svg width="205"
                                        height="205">
                                        <use xlink:href="#arrow-up-right-big"></use>
                                    </svg></span>
                            </a>
                    ...
                    <div class="row justify-content-between gy-40 gy-lg-0">
                        ...
                        <div class="col-lg-5">
                            <h3 class="straight-line-wrapper fw-semibold position-relative mb-20"> <span
                                    class="straight-line"></span>Harmonia Wayfinder</h3>
                            <div class="map-image parallax position-relative">
                                ...
                                <div class="map-popup-content">
                                    ...
                                    <p>135W, 46nd Street, New York</p><a id="mapDirectionBtn" href="#"
                                        class="btn btn-gradient btn-sm d-flex align-items-center justify-content-center custom-roboto gap-10 btn-map-direction"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="RoutingMapLabel">135 W, 46nd Street,
                                                New York</h1>
        ...
        <div class="container">
            <div class="row gy-lg-0 gy-10 justify-content-between align-items-center text-center text-lg-start">
                <div class="col-lg-4 order-3 order-lg-1">
                    <p class="mb-0 footer-nav">&copy; 2023 <a href="https://themeperch.net/"
                            class="text-decoration-none" target="_blank">Themeperch</a>. All rights Reserved.</p>
                </div>
                <div class="col-lg-4 order-1 order-lg-2">
                    <a class="navbar-brand d-flex justify-content-center" href="index-2.html"
                ...
                <div class="col-lg-4 order-2 order-lg-3">
                    <ul
                        class="footer-nav list-unstyled d-flex justify-content-center justify-content-lg-end gap-30 mb-0">
                        <li class="nav-item">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
        ...
        <symbol id="eventiva-logo" viewBox="0 0 16 16">
            <path fill-rule="evenodd" clip-rule="evenodd"
                d="M20 0H0V20H10V24.5455H24.5455V10H20V0ZM20 10H10V20H20V10Z" fill="#B30D5D" />
        </symbol>
        ...
        <symbol id="grammy-icon" viewBox="0 0 40 40">
            <mask id="path-1-outside-1_857_165" maskUnits="userSpaceOnUse" x="6.4585" y="0.776611" width="27"
        ...
        <symbol id="billboard-icon" viewBox="0 0 40 40">
            <mask id="path-1-outside-1_857_167" maskUnits="userSpaceOnUse" x="0.25" y="0.25" width="38"
...
<!-- Mirrored from themeperch.net/html/eventiva/home-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 May 2024 15:17:42 GMT -->
